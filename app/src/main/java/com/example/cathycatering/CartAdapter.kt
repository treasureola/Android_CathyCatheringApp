...
class CartAdapter(private var cartItems: MutableList<CartItem>, private val callback: ViewCart, private val Pcallback: Product) : RecyclerView.Adapter<CartAdapter.ViewHolder>() {
